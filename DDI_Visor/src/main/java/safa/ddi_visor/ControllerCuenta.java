...
public class ControllerCuenta implements Initializable {
    ...
    public Cuenta leeCampos() {
        ...
        tfNumeroNuevas.setStyle("-fx-effect:  innershadow(three-pass-box, gray, 5 , 0.5, 1, 1);");
        tfFechaNuevas.setStyle("-fx-effect:  innershadow(three-pass-box, gray, 5 , 0.5, 1, 1);");
        tfSaldoNuevas.setStyle("-fx-effect:  innershadow(three-pass-box, gray, 5 , 0.5, 1, 1);");
        try {
            ...
            tfNumeroNuevas.setStyle("-fx-effect:  innershadow(three-pass-box, red, 5 , 0.5, 1, 1);");
        }
        ...
        try {
            ...
            tfFechaNuevas.setStyle("-fx-effect:  innershadow(three-pass-box, red, 5 , 0.5, 1, 1);");
        }
        try {
            saldo = Double.valueOf(tfSaldoNuevas.getText());
        } catch (Exception e) {
            tfSaldoNuevas.setStyle("-fx-effect:  innershadow(three-pass-box, red, 5 , 0.5, 1, 1);");
        }
