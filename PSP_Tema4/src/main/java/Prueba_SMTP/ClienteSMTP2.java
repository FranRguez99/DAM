...
public class ClienteSMTP2 {
    public static void main(String[] args) throws NoSuchAlgorithmException, UnrecoverableKeyException,
        ...
        String username = "franciscorodriguezespinosa@safareyes.es";
        String password = "(FfRr080499";
        int puerto = 587;
        String remitente = "Joselito el Gallo";
        ...
        try {
            ...
            if (client.execTLS()) {
                ...
                if (client.auth(AuthenticatingSMTPClient.AUTH_METHOD.LOGIN, username, password)) {
                    ...
                    String destino1 = "franrguez99@gmail.com";
